...
final public class SharedPrefsUtils {
    ...
    public static boolean saveData(Context context, Gson gson, String prefKey, Object object) {
        if (object == null) {
            return false;
        }
    ...
    public static <T> T getSavedData(Context context, Gson gson, String prefKey, Class<? extends T> clazz) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
